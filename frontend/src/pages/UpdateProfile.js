...
const UpdateProfile = () => {
    ...
    const [missionStatement, setMissionStatement] = useState(currentInfo.missionStatement);
    ...
    const handleMissionStatementChange = (event) => setMissionStatement(event.target.value);
